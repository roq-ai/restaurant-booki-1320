  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Revolutionizing Your Dining Experience. Reserve Tables, Manage Reservations, and Menus All in One Place. Simplifying Restaurant Management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Revolutionizing Your Dining Experience. Reserve Tables, Manage Reservations, and Menus All in One Place. Simplifying Restaurant Management.`}
            </Text>
            <Box
